...
import { Shipping, ShippingPincodeGroup } from '../Shipping/shipping.models';
...
export class Warehouse extends BaseModel {
  ...
  @OneToMany(() => WarehousePincodeGroup, foo => foo.warehouse)
  warehousePincodes: any[];
...
@Entity()
export class WarehousePincodeGroup extends BaseModel {
  ...
  @ManyToOne(() => Warehouse, group => group.id)
  @JoinColumn({ name: "warehouse_id" })
  warehouse: Warehouse;
...
@Entity()
export class PincodeGroupPincodes extends BaseModel {
  @ManyToOne(() => PincodeGroup, foo => foo.id)
  @JoinColumn({ name: "group_id" })
  group: PincodeGroup;
