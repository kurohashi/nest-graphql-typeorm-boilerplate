...
import { TaxSlab, Category, SubCategory, SSubCategory, Product, WarehouseProduct, CollectionReference, Warehouse, CollectionWarehouseProduct, BasePricing, UserSpecificPricing, PincodeGroup, PincodeGroupPincodes, WarehousePincodeGroup } from './product.models';
...
@Resolver()
export class PincodeResolver extends BaseAdminResolver(PincodeGroupPincodes){
  constructor(dataSource: DataSource) {
    super(dataSource, true, undefined, undefined, true);
  }
}
...
@Resolver()
export class WarehousePincodeGroupResolver extends BaseAdminResolver(WarehousePincodeGroup){
  constructor(dataSource: DataSource) {
    super(dataSource, true, undefined, undefined, true);
  }
}