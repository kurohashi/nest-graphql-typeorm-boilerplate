...
import { Any, DataSource, EntityManager, Equal, MoreThanOrEqual, Repository } from 'typeorm';
...
export class OrderController {
  ...
  @Post("salesOrderInfo")
  async salesOrderInformation(@Req() req: Request, @Res() res){
    console.log(JSON.stringify(req.body));
    res.send({msg:"okay zoho"})
  }

  @Post("invoice")
  async invoiceHistory(@Req() req: Request, @Res() res){
